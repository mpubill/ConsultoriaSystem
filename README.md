...
ConsultoriaSystem.sln
│
├── ConsultoriaSystem.Api
│   ├── Controllers/
│   ├── Services/
│   ├── Repositories/
│   ├── Entities/
...
│   └── Program.cs
│
└── ConsultoriaSystem.Test
    ├── Services/
    └── GlobalUsings.cs

4. Base de Datos y Stored Procedures
...
dotnet restore
2. Configurar la cadena de conexión en appsettings.json (Se ha usado SQL EXPRESS con Windows Auth)
3. Ejecutar el script SQL de la BD
4. Ejecutar el proyecto:
dotnet run --project ConsultoriaSystem.Api
...
7. Pruebas en Postman (Consultores + Auth)
